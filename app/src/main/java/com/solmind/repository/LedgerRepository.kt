package com.solmind.repository

import com.solmind.data.database.LedgerDao
import com.solmind.data.database.SolanaWalletDao
import com.solmind.data.database.AILedgerDatabase
...
import com.solmind.service.AIService
import com.solmind.service.SolanaService
...
class LedgerRepository @Inject constructor(
    ...
    private suspend fun createLedgerEntryFromSolanaTransaction(
        transaction: com.solmind.data.model.SolanaTransaction,
        userAddress: String
    ): LedgerEntry {
        ...
        val category = aiResult?.category ?: when (transaction.type) {
            com.solmind.data.model.SolanaTransactionType.TRANSFER -> {
                TransactionCategory.TOKEN_TRANSFER
            }
            com.solmind.data.model.SolanaTransactionType.TOKEN_TRANSFER -> {
                TransactionCategory.TOKEN_TRANSFER
            }
            com.solmind.data.model.SolanaTransactionType.SWAP -> {
                TransactionCategory.DEFI_SWAP
            }
            com.solmind.data.model.SolanaTransactionType.STAKE -> {
                TransactionCategory.DEFI_STAKING
            }
            com.solmind.data.model.SolanaTransactionType.NFT_MINT -> {
                TransactionCategory.MINTING
            }
            com.solmind.data.model.SolanaTransactionType.NFT_TRANSFER -> {
