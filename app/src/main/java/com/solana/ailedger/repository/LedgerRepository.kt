package com.solana.ailedger.repository
...
import com.solana.ailedger.service.SolanaService
...
class LedgerRepository @Inject constructor(
    ...
    private fun createLedgerEntryFromSolanaTransaction(
        transaction: com.solana.ailedger.data.model.SolanaTransaction,
        userAddress: String
    ): LedgerEntry {
        ...
        val category = when (transaction.type) {
            com.solana.ailedger.data.model.SolanaTransactionType.TRANSFER -> {
                if (isIncoming) TransactionCategory.OTHER else TransactionCategory.OTHER
            }
            com.solana.ailedger.data.model.SolanaTransactionType.TOKEN_TRANSFER -> {
                TransactionCategory.INVESTMENT
            }
            com.solana.ailedger.data.model.SolanaTransactionType.SWAP -> {
                TransactionCategory.INVESTMENT
            }
            com.solana.ailedger.data.model.SolanaTransactionType.STAKE -> {
                TransactionCategory.INVESTMENT
            }
            com.solana.ailedger.data.model.SolanaTransactionType.NFT_MINT,
            com.solana.ailedger.data.model.SolanaTransactionType.NFT_TRANSFER -> {
